  ...
  return (
    <div className={styles.container} id="המסלולים שלי">
      ...
      <div className={styles.optionsWrapper}>
        ...
        <div className={styles.option}>
          ...
          <ul className={styles.optionList}>
            ...
            <li>פגישות בזום למעקב ועדכונים</li>
          </ul>
      ...
      <div className={styles.commonInfo}>
        ...
        <p>אני כאן כל הזמן בכדי לעזור לך עם ההתמדה והמשמעת העצמית, והכי חשוב, אדאג שתאהבי את התהליך ותהני מהדרך, כי מניסיון – זה מה שמשנה הכי הרבה!</p>
      </div>
